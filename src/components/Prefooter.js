  ...
  return (
    <div className='prefooter'>
         <div className='tincards'>
              <div >
                   { repeatIcon}
              <p><b>100% secure payments</b><br/>Lorem ipsum dolor sit amet consectetur.</p>
              </div>
              <div>
                   {shieldIcon}
              <p><b>1 year guarantee</b><br/>Lorem ipsum dolor sit amet consectetur. </p>
              </div>
              <div>
                   {mapIcon}
              <p><b>Paybacks and replacements</b><br/>Lorem ipsum dolor sit amet consectetur . </p>
              </div>
         </div>
         <div className='prefoot2'>
              <div>
                   
              <p><b>Let's stay in touch</b></p> <span>    Get updates about your favourite products
              </span>
